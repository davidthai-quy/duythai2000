...
const schemaUser = new mongoose.Schema({
    ...
    // _id:mongoose.Schema.ObjectId, phai xoa di
    user_full: String,
    user_mail: String,
    user_pass: String,
    user_level: Number
...
// UserModel.updateOne({_id: "5db660e0a9dc75c99d11ad1d"}, {user_pass: "88888888"}).exec((err, docs)=>{
//     console.log(err)
//     console.log(docs)
// })

//  Sử dụng Model thông qua phương thức (xóa dữ liệu)
// UserModel.deleteOne({_id: "5ddd1b09ed83140938f5648b"}, (err, data)=>{
